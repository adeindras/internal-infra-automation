...
String taskTitle = "This is Task Title"
String taskDesc = "This is task description."
String taskImpact = "This is task impact."
...
{%- if cookiecutter.clone_deployments %}
        dir('deployments') {
          checkout (
            changelog: false,
            poll: false,
...
{% endif -%}
    ...
    stage('Run-1') {
      when { expression { params.TARGET_ENVIRONMENT_NAME != 'blank' } }
      steps {
        dir("$WORKSPACE/hosting/rollout/{{ cookiecutter.fiscal_quarter }}/{{ cookiecutter.project_slug }}") {
          // Add your scripts here
          sh 'bash sample_kubectl.sh'
        }
        script {
          // Update with your message here
          successJobReply( "This stage-1 is completed" )
        }
      }
    }
    ...
    stage('Run-2') {
      ...
      steps {
        ...
        script {
          // Update with your message here
          successJobReply( "This stage-2 is completed" )
        }
      }
    }
  }
